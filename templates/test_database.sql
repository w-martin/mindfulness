...
DROP DATABASE test_mindfulness;
--
-- TOC entry 2188 (class 1262 OID 16460)
-- Name: test_mindfulness; Type: DATABASE; Schema: -; Owner: mindfulness
--

CREATE DATABASE test_mindfulness WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_GB.UTF-8' LC_CTYPE = 'en_GB.UTF-8';

CREATE USER mindfulness WITH PASSWORD 'mindfulness';

ALTER DATABASE test_mindfulness OWNER TO mindfulness;

\connect test_mindfulness
